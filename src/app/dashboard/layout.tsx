...
const navigation = [
  ...
  { name: "Vault", href: "#", icon: LockClosedIcon, current: false },
...
export default function Dashboard({ children }: { children: React.ReactNode }) {
  ...
  const userNavigation = [
    { name: "Your profile", href: "#", onClick: () => router.push("/profile") },
      ...
      <div>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          ...
          <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4">
            <div className="flex h-16 shrink-0 items-center justify-start gap-4 ">
              <Image
                width={32}
                height={32}
                alt="link keeper logo"
                src="/logo.png"
                className="h-8 w-auto"
              />
              <span className="text-white font-serif italic text-xl">
        ...
        <div className="lg:pl-72">
          <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
            ...
            >
              ...
              <TbMenu3 aria-hidden="true" className="size-6" />
            </button>
              ...
              <div className="flex items-center gap-x-4 lg:gap-x-6">
                ...
                <Menu as="div" className="relative">
                  <MenuButton className="-m-1.5 flex items-center p-1.5">
                    ...
                    <Avatar>
                      <AvatarImage
                        src="https://hackwhiz.com/user.png"
                        alt="@shadcn"
                      />
                      <AvatarFallback>
